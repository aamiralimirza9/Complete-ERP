...
/**
 * Servlet implementation class InvoiceReport
 */
@WebServlet("/InvoiceReport")
public class InvoiceReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("v")!=null){
			System.out.println("the val is "+request.getParameter("v"));
			
			Map<String, Object> param=null;
			param = new HashMap<String,Object>();
			param.put("qty", request.getParameter("v"));
			param.put("Title", "Invoice");
		
	    	try {
	    		System.out.println(request.getParameter("v"));
			String reportFileName = request.getParameter("v");
