...
/**
 * Servlet implementation class sellInvoiceReport
 */
@WebServlet("/sellInvoiceReport")
public class sellInvoiceReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public sellInvoiceReport() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			param.put("qty", request.getParameter("name"));
			param.put("Title", "Invoice");
		
	    	try {
	    		System.out.println(request.getParameter("name"));
			String reportFileName = request.getParameter("Stock Details");
