...
/**
 * Servlet implementation class cashreport
 */
@WebServlet("/cashreport")
public class cashreport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		param.put("qty", request.getParameter("qty"));
		param.put("Title", "Stock Details");
	
    	try {
    		
		String reportFileName = "cash";
