...
<html lang="en">
  <head>
   <meta charset="utf-8">
    ...
    <title>Inventory Good Reciepts</title>
    ...
    <link href="assets/css/style-responsive.css" rel="stylesheet">
	  ...
	  <script src="js/goodsRecipt.js"></script>
	<!--    <script src="js/partialInventoryShow.js"></script>
	  <script src="js/ChangePage2.js"></script>
	   -->
  ...
  $(function ()
	{
        ...
        $(document).ready(function(){
         	 ...
         	 $("#PrId").keyup(function(e){
         		if(e.which == 16) {
         		var VendorId=$("#PrId").val();
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>goods recipt data</h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form"  id="reciept">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input type="text" id="PrId" value=<%= request.getParameter("name") %> class="form-control" required>
                              </div>
                              <div id="check2" class="col-sm-1"></div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">gr Delivery date</label>
                              <div class="col-sm-6">
                                  <input type="name" id="nam" class="form-control"  required>
                              </div>
                          </div>
                            ...
                            <input  type="submit" id="btn1"  class="btn btn-theme" value="add row" >
                            </div>
                            </center>
