              ...
              var ac="trailbalance";   
                 $.ajax({
   				...
   				{					var bb=	data[a];
   	      		...
   	      		$('#mytable tr').eq(0).after(' <tr><td>'+bb.id+'</td><td>'+bb.acno+'</td><td>'+bb.acname+'</td><td>'+bb.debit+'</td><td>'+bb.credit+'</td></tr>');  					
   							}
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          			<div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i>General Ledger</h4>
                      	<div class="row">
