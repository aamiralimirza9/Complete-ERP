      ...
      <section id="main-content">
          <section class="wrapper">
          	...
          	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="purchasingReq.jsp"><img class="img-responsive" src="imgs/addpr.jpg" alt=""></a>
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="ShowpurchasingRqtable.jsp"><img class="img-responsive" src="imgs/showpr.jpg" alt=""></a>
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="InventoryGoodsRecipets.jsp"><img class="img-responsive" src="imgs/addgoodr.jpg" alt=""></a>
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="showPartialInventory.jsp"><img class="img-responsive" src="imgs/showgoodsr.jpg" alt=""></a>
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="partialGoodsIssues.jsp"><img class="img-responsive" src="imgs/addgoodsi.jpg" alt=""></a>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-3 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                        
		                            	<a class="fancybox" href="showGoodsIssues.jsp"><img class="img-responsive" src="imgs/showgi.jpg" alt=""></a>
