        	...
        	var cId=$("#id1").val();
        		...
        		datatype:"json",
        			success:function(data){
       				 ...
       				 $("#customerNumber").val(bb.dDescription).text(bb.dDescription).appendTo("#customerNumber");
       				 $("#payAmount").val(bb.paymentAmount).text(bb.paymentAmount).appendTo("#payAmount");
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" >
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Enter Invoice Number</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="id1" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Customer Number</label>
                              <div class="col-sm-10">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Payment Amount</label>
                              <div class="col-sm-10">
