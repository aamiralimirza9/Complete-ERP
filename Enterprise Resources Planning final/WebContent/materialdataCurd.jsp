			...
			var dat="key";
              ...
              $.ajax({
				...
				{					var bb=	data[a];
	      		...
	      		$('#mytable tr').eq(0).after(' <tr><td>'+bb.Mt_No+'</td><td>'+bb.Mt_name+'</td><td>'+bb.Mt_weight+'</td><td>'+bb.Mt_price+'</td><td>'+bb.Mt_desc+'</td><td>'+bb.Mt_typeNo+'</td><td><p data-placement="top" data-toggle="tooltip" title="Edit"><button class="Add" btn btn-primary"  data-id='+bb.Mt_No+' data-nam='+bb.Mt_name+'  data-type='+bb.Mt_weight+' data-subtype='+bb.Mt_price+'  data-mtdesc='+bb.Mt_desc+' data-mt='+bb.Mt_typeNo+'  data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></p></td><td><p data-placement="top" data-toggle="tooltip" title="Delete"><button class="open-delBookDialog btn btn-primary" data-title="Delete" data-id='+bb.Mt_No+' data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></p></td></tr>');  					
							}
