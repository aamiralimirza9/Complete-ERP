          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="PrButtonPage.jsp">Purchasing requesition</a></li>
                          <li><a  href="gallery.html">Purchasing order</a></li>
                          <li><a  href="purchasingReq.jsp">Purchasing Req data</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="blank.html">Goods recipets</a></li>
                          <li><a  href="login.html">Goods issues</a></li>
