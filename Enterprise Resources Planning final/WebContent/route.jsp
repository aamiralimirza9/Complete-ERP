                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" >
                       <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Enter Description</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="descirption" required>
                              </div>
                          </div>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                     <label class="col-sm-2 col-sm-2 control-label" for="inlineFormCustomSelect">Choose Route</label>
                      <select class="custom-select mb-2 mr-sm-2 mb-sm-0" id="route">
