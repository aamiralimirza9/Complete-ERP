                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form"  id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Product Categroy Name</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="pCatName" required>
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Allocation Number</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="alloNumber" required>
                              </div>
                          </div>
