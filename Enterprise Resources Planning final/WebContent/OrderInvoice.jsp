...
$(document).ready(function() {
      	      ...
      	      $.ajax({
	      		...
	      		$('#deliveryTable tr').eq(0).after(' <tr><td>'+bb.oInviceId+'</td><td id="des">'+bb.dDescription+'</td><td id="dDate">'+bb.dDate+'</td><td id="dFrom">'+bb.dFrom+'</td><td id="dTo">'+bb.dTo+'</td><td id="weight">'+bb.weight+'</td><td id="rId">'+bb.routId+'</td><td id="cNo">'+bb.contactNo+'</td><td id="vId">'+bb.venderId+'</td><td id="cusNo">'+bb.customerNo+'</td><td id="pr">'+bb.price+'</td><td id="vechileNo">'+bb.vechileNo+'</td><td id="dName">'+bb.driverName+'</td></tr>');  					
       ...
       alert(s);
		...
		success:function(data){
			...
			window.open("demo?name=Orderinvoice1");
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>ERP</b></a>
            <!--logo end-->
