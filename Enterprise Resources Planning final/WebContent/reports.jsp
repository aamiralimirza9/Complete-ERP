						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="TrailBalance.jsp"><img class="img-responsive" src="resources/trial balance.jpg" alt=""></a>
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="demo?name=income"><img class="img-responsive" src="resources/fanincial statement.jpg" alt=""></a>
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="AccountRecieveable.jsp"><img class="img-responsive" src="resources/accountRecivable.jpg" alt=""></a>
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="AccountPayablejsp.jsp"><img class="img-responsive" src="resources/cash payble.jpg" alt=""></a>
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="GeneralLedger.jsp"><img class="img-responsive" src="resources/account Ledger.jpg " alt=""></a>
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="demo?name=balancesheet"><img class="img-responsive" src="resources/balance sheet.jpg" alt=""></a>
