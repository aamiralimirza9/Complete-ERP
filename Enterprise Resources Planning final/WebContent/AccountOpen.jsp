	...
	$.ajax({
    	...
    	$('#acno').keyup(function(event) {
       		...
       		$.ajax({
				...
				if(data=="success"){
					  $("#response").html("<span class='fa fa-warning' style='font-size:30px;color:red'></span>");
	        		     
	        		   
				}         		
				else{
					 $("#response").html(" <span class='glyphicon glyphicon-ok' style='font-size:30px;color:green'></span>");  
	       		}
    	...
    	$('#actitle').keyup(function(event) {
       		...
       		$.ajax({
				...
				if(data=="success"){
					  $("#titles").html("<span class='fa fa-warning' style='font-size:30px;color:red'></span>");
	        		   
				}         		
				else{
	           		
	           		$("#titles").html(" <span class='glyphicon glyphicon-ok' style='font-size:30px;color:green'></span>");
				}
          ...
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Finanace and Accounting</h3>
          	 <div class="panel panel-primary">
          	 		<div class="panel-heading">Account Open </div>
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input type="text" id="acno" class="form-control" required>
                                     <div id="response" class="col-sm-2 col-sm-2 control-label"></div>
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                    		    ...
                    		    <div id="titles" class="col-sm-2 col-sm-2 control-label"></div>
                              </div>
