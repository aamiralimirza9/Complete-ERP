          ...
          $(document).ready(function() {
    	      ...
    	      $.ajax({
    			...
    			{					var bb=	data[a];
                      ...
                      $("#partial").val(bb.productTypeId+1).text(bb.productTypeId+1).appendTo("#partial");
        		...
        		$("#customer").keyup(function(){
          	      ...
          	      $.ajax({
          			...
          			for(var a=0 ; a<data.length; a++)
          			{					var bb=	data[a];
                    $("#customer").val(bb.customerName).text(bb.customerName).appendTo("#customer");
      		...
      		$("#search").keyup(function(){
      	      ...
      	      $.ajax({
      			...
      			{					var bb=	data[a];
      		      		...
      		      		$('#Materialshow tr').eq(0).after(' <tr><td>'+bb.productName+'</td><td>'+bb.quantity+'</td><td><p data-placement="top" data-toggle="tooltip" title="Edit"><button  data-name='+bb.productName+' data-quan='+bb.quantity+' data-prc='+bb.price+' class="open-AddBookDialog btn btn-primary"   data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></p></td></tr>');  					
      ...
      $('#placeOrder').click(function(){
        ...
        var order=$("#orderid").val();
     	var partial=$("#partial").val();
  	    ...
  	    var totaltax=0;
	    var total=0;
	    var mtqt=$(".modal-body #quantity").val();
	    quantity
		...
		$('#dbtable tr td').eq(-2).after("<td colspan='2' >"+total+"</td>");

		$('#dbtable tr td').eq(-1).after("<td colspan='2' >"+totaltax+"</td>");
		//$("<td colspan='2'>"+total+"</td>").eq(0).insertAfter('#Materialshow tr td:last');
  	 	...
  	 	$.ajax({
			...
			window.open("demo?name=customerOrder");
		window.location.href="delivery.jsp?porder="+partial;		   
  		   });
          	...
          	<h3><i class="fa fa-angle-right"></i>Sales and Distribution</h3>
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" >
                              ...
                              <label class="col-sm-1 col-sm-1 control-label">Partial OrderNo</label>
                              <div class="col-sm-8">
                                  <input type="text" id="partial" class="form-control" required>
                              </div></div>
                              <div class="form-group">
                              <label class="col-sm-1 col-sm-1 control-label">Order No</label>
                              <div class="col-sm-8">
                                  <input type="text" id="orderid" value="<%=request.getParameter("somval") %>" class="form-control" required>
                              </div>
                          </div>
                              ...
                              <div class="col-sm-8">
                                  <input type="text" id="odate" class="form-control" required>
                              </div></div>
                           <div class="form-group">
...
<div class="panel panel-primary">
            		  ...
            		  <table id="dbtable" class="table table-bordered table-striped table-condensed">
                            <tbody>
                              ...
                              <th>Delete</th>
                                        ...
                                        <thead>  
                                   <tr>
            <td  colspan="3">Total without G.S.T Tax</td>
            ...
            <tr>
            <td  colspan="3">Total With G.S.T Tax (14.5%)</td>
