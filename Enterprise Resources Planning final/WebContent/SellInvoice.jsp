...
$(document).ready(function() {
      	      ...
      	      $.ajax({
      			...
      			{					var bb=	data[a];
		      		...
		      		$('#sellInvoice tr').eq(0).after(' <tr><td id="pName">'+bb.productName+'</td><td id="quan">'+bb.quantity+'</td><td class="price" id="p">'+bb.price+'</td></tr>');  					
       ...
       alert(s);
		...
		datatype:"json",
		success:function(data){
			alert("HI REPORT GGGGGGGGGGGG!!!!!!!");
			window.open("demo?name=sellInvoice");
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right">Sales And Distribution</i> </h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <table class="table" id="sellInvoice">
...
</table><button type="button" class="btn btn-primary btn-sm" id="print">Print</button>
