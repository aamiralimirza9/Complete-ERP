    ...
    <link href="assets/css/style-responsive.css" rel="stylesheet">
       ...
       <script>
        ...
        $(document).ready(function() {
        	...
        	var cId=$("#cId").val();
        		...
        		datatype:"json",
        			success:function(data){
        				for(var a=0 ; a<data.length; a++)
        				{					var bb=	data[a];
        				 $("#cId").val(bb.Id+1).text(bb.Id+1).appendTo("#cId");
        				}
        			}
        	...
        	$("#from1").submit(function(value){
        		  var radioValue = $("input[name='optradio']:checked").val();
        		  var radioValue1 = $("input[name='optradio1']:checked").val();
        		  
        		if(radioValue=="maketobuy"){
        		    // window.location="makeToBuy.jsp";
        		    window.open("makeToBuy.jsp");
        		    
        		     }
        		if(radioValue1=="maketostock"){
        		    // window.location="makeToBuy.jsp";
        		    window.open("makToStock.jsp");
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  ...
                  	  <!-- FORM -->
                      <form class="form-horizontal style-form" id="from1">
                       <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">OrderNo</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="cId" required>
                              </div>
                          </div>
  <div class="radio">
  <label><input type="radio"  name="optradio" id="a" value="maketobuy" >Buy</label>
</div>
<div class="radio">
  <label><input type="radio"  name="optradio1" id="b" value="maketostock" >Stock</label>
  
</div>
 
<div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Delevery Date</label>
                              <div class="col-sm-10">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="oStatus" required>
                              </div>
                          </div>
