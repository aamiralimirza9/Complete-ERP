      ...
      $(document).ready(function(){
	      ...
	      $.ajax({
			...
			{					var bb=	data[a];
                  ...
                  $("#mpId").val(bb.productTypeId+1).text(bb.productTypeId+1).appendTo("#mpId");
    			...
    			$.ajax({
    				...
    				datatype:"json",
      	    		success:function(data){
      	    			...
      	    			window.open("demo?name=pinventory");
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Production </h3>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          		<div class="panel panel-primary">
          	<div class="panel-heading">Production Inventory</div>
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" >
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Product Inventory Id</label>
                              <div class="col-sm-8">
                                  <input type="text" id="mpId" class="form-control round-form" >
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input type="text" id="podate" class="form-control round-form" >
                              </div>
                          </div> 
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Order Id</label>
                              <div class="col-sm-8">
                                  <input type="text" id="OrderId" value=<%=request.getParameter("somval") %> class="form-control round-form" >
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input type="text" id="PoId" value=<%=request.getParameter("po") %> class="form-control round-form" >      
                              </div>
                              <div id="check3" class="col-sm-1"> </div>
                          </div>
                              
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Lot No</label>
                              <div class="col-sm-8">
                                  <input type="text" id="lot" class="form-control round-form" >
                              </div>
                          </div>
          	...
          	<div class="row mt">
                            ...
                            <div class="form-group">
                             ...
                             <center>
                              <div class="col-sm-10">
                                  <input type="button" id="btn2" value="add row">
                              </div>
                              </center>
                             </div>
