              ...
              var ac="cash";   
                 $.ajax({
   				...
   				{					var bb=	data[a];
   	      		...
   	      		$('#mytable tr').eq(0).after(' <tr><td>'+bb.cvdate+'</td><td>'+bb.cvno+'</td><td>'+bb.account+'</td><td>'+bb.amount+'</td><td>'+bb.actype+'</td><td>'+bb.memo+'</td></tr>');  					
   							}
          ...
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Finance and Accounting</h3>
          		 ...
          		 <div class="panel panel-primary">
          	 		<div class="panel-heading">Cash Voucher List</div>
