      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	  <h4 class="mb"><i class="fa fa-angle-right"></i>Sales and Distribution</h4>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" id="form1" >
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Production Plant</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control " id="pPlant" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Storage Location</label>
                              <div class="col-sm-10">
                                  <input class="form-control"  type="text" id="sLoc" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Material Group</label>
                              <div class="col-sm-10">
                                  <input class="form-control" type="text" id="matGroup" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Unit</label>
                              <div class="col-sm-10">
                                  <input class="form-control" type="text" id="unit" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Weight</label>
                              <div class="col-sm-10">
                                  <input class="form-control" type="text" id="weight" required>
                              </div>
                          </div>
                         <!--   <div class="form-group">
                             <label class="col-sm-2 col-sm-2 control-label">Availbility Check</label>
                              <div class="col-sm-10">
                                  <input class="form-control" type="text" name="avalChk">
                              </div>
                          </div> --> 
                          <div class="form-group">
                     <label class="col-sm-2 col-sm-2 control-label" for="inlineFormCustomSelect">Product Type Name</label>
                      <select class="custom-select mb-2 mr-sm-2 mb-sm-0" id="productTypeName">
