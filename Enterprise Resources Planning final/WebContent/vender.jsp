          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> vendor Form</h4>
                      <form id="vendor" class="form-horizontal style-form" method="Post">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input type="text" id="comapyAddress" class="form-control" required>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Phone Number</label>
                              <div class="col-sm-6">
                                  <input class="form-control"  id="copmanyContact" type="text" required >
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Mobile Number</label>
                              <div class="col-sm-6">
                                  <input class="form-control"  id="MobileNumber" type="text" required >
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">NTN Number</label>
                              <div class="col-sm-6">
                                  <input type="text"  class="form-control"  id="companyNtnNumber" required>
                              </div>
                          </div>
                         <div class="form-group">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Bank Account</label>
                              <div class="col-sm-6">
                                  <input type="text"  class="form-control" id="BAccount" required>
                              </div>
                          </div>
                          <div class="form-group">
                               <center>
                              <div >
                                  ...
                                  <input type="submit" id="btn" class="btn btn-theme"  value="Add Vendor">
                              </div>
                              </center>
                          </div>
