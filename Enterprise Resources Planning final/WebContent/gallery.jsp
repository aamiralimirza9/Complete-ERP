						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="BankPayment.jsp"><img class="img-responsive" src="resources/add bank payment.jpg" alt=""></a>
						...
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            	...
		                            	<a class="fancybox" href="assets/img/portfolio/port03.jpg"><img class="img-responsive" src="resources/Show bank payment.jpg" alt=""></a>
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 desc">
						<div class="project-wrapper">
		                    <div class="project">
		                        <div class="photo-wrapper">
		                            <div class="photo">
		                            	<a class="fancybox" href="assets/img/portfolio/port05.jpg"><img class="img-responsive" src="resources/show bank voucher.jpg" alt=""></a>
		                            </div>
		                            <div class="overlay"></div>
		                        </div>
		                    </div>
