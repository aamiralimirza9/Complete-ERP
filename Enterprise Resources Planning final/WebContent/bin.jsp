          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Bin Data</h4>
                      <form  id="bin" class="form-horizontal style-form" method="post">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Bin Name</label>
                              <div class="col-sm-6">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Bin Description</label>
                              <div class="col-sm-6">
                                  <input type="text" id="BinDesc" class="form-control" Required>
                              </div>
                          </div>
                        <center>
                          <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                  <input type="submit" class="btn btn-theme" id="btn1" value="Add Bin" >
