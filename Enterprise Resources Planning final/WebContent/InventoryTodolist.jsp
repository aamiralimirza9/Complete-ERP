...
<html lang="en">
          ...
          //   $(".modal-body #OrderId").val(mtOrder);
        	 ...
        	 $.ajax({
     			...
     			success:function(data){
     	    		...
     	    		$('#data tr').eq(0).after(' <tr><td>'+bb.mno+'</td><td>'+bb.name+'</td><td>'+bb.mtQuantity+'</td><td>'+bb.price+'</td><td><Button type="button" class="removebutton" title="remove this row">X</Button></td></tr>data-toggle="modal" data-target="#edit"');			
        	...
        	var v=$(this).val()	
     		...
     		success:function(data){
     			...
     			var v=data[bb.ponOId];
     				...
     				abc="<div class='col-lg-4 col-md-4 col-sm-4 mb'><div style='background:white' class='product-panel-2 pn'><h5>Goods Recipts</h5><div class='badge  badge-hot' style='background:#1ACAC0'>"+bb.vendorName+"</div><h5 class='mt'>"+bb.invtodoId+"</h5><h6>"+bb.PrId+"</h6><button  data-id="+bb.PrId+"  data-toggle='modal' class='Add'  data-target='#edit1' >show view</button></br></br><a href='InventoryGoodsRecipets.jsp?name="+bb.PrId+"'  class='btn btn-info'  role='button'>Goods Recipts</a></div></div>";
  ...
  <section id="container" >
   ...
   <div class="modal-content">
     ...
     <!--      <button type="submit"  id="total"   class="btn btn-theme">remove to do list</button>        -->                           
