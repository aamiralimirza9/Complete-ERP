...
<% String s=(String)session.getAttribute("uname");%>
    	...
    	{					var bb=	data[a];
    	   ...
    	   $('<option>').val(bb.acTitle).text(bb.acTitle).appendTo(select);	
      ...
      if(testvalue!="null"){   
      	$.ajax({
	    		...
	    		var value=$("#search").val();        
	        		...
	        		success:function(data){
	        			...
	        			{	var bb=	data[a];
	        				alert(bb.acTitle);
	        				$('#search').val("");
	        				$('#search').val($('#search').val() +bb.acTitle );
        	...
        	$('#print').click(function(event){
        		var nam = $("#search").val();
        		var p="demo?name=generalledger&val="+nam;
			     	window.open(p);
  ...
  <section id="container" >
	...
	<select id="itemno"  class="col-sm-3 col-sm-3">
