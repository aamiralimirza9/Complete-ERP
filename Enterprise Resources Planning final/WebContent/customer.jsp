          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form"  name="form1"  >
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Customer Company Name</label>
                              <div class="col-sm-10">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Customer Bank Account</label>
                              <div class="col-sm-10">
                                  <input class="form-control"  type="text" name="customerBankAccount" id="customerBankAccount" required>
                              </div>
                          </div>
