...
<html lang="en">
    ...
    <!--  <script>
     ...
     $(document).ready(function() {
  		...
  		$("#orderId").keyup(function(){
    		...
    		$.ajax({
    			...
    			success:function(data) {
    				...
    				{	
    					var bb=	data[a];
      		      		$('#Materialshow tr').eq(0).after('<tr><td>'+bb.productName+'</td><td>'+bb.quantity+'</td></tr>');  					
  		...
  		$("#save").click(function(){
  		  ...
  		  window.open('orderMts.jsp?somval=' +orderId );
  		...
  		$.ajax({
  			...
  			success:function(data) {
  				...
  				{		
  					var bb=	data[a];
    		      		$('#Materialshow tr').eq(0).after('<tr><td>'+bb.productName+'</td><td>'+bb.quantity+'</td><td><span style="background-color: green; color: white"  id="status">Ready</span></td></tr>');  					
  ...
  <!--sidebar start-->
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Sales And Destribution </h3>
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" >
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"> Order Check </label>
                              <div class="col-sm-10">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading">Status Check</h4>
      </div>
