              ...
              var ac="bankReciept";   
                 $.ajax({
   				...
   				{					var bb=	data[a];
   	      		...
   	      		$('#mytable tr').eq(0).after(' <tr><td>'+bb.bankacno+'</td><td>'+bb.amount+'</td><td>'+bb.bankname+'</td><td>'+bb.recieptdate+'</td><td>'+bb.comment+'</td><td>'+bb.voucher+'</td></tr>');  					
   							}
          ...
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Finance and Accounting</h3>
          		 ...
          		 <div class="panel panel-primary">
          	 		<div class="panel-heading">Bank Reciept Voucher Detail</div>
