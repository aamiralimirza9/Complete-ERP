          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i>Cash Payment</h4>
                      <form class="form-horizontal style-form" method="get">
                        ...
                        <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input type="text" class="form-control" id="nam" name="dateofbirth" >
                              </div>
                        </div>
                         <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Account</label>
                              <div class="col-sm-6">
                                  <input type="text" id="actitle" class="form-control">
