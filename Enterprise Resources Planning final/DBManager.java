...
public static void addUser(String fullName,String userName, String password,String email,String nic,String gender,String dateOfBirth,String phoneNumber,String roles){
	 Connection con;
	 con=(Connection) DBConnection.getConnection();
	 try {
			Statement st=(Statement) con.createStatement();
			 String sql= "insert into employee(name,uname,password,email,nic,gender,cell_no,role)values('"+fullName+"','"+userName+"','"+password+"','"+email+"','"+nic+"','"+gender+"','"+phoneNumber+"','"+roles+"')"  ;
			System.out.println(sql);
			st.executeUpdate(sql);
